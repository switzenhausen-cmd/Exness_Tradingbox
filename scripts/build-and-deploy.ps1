...
$targetEaFile = Join-Path $targetRoot "Exness_TradingBox_v1_012_MT5.mq5"
...
$required = @(
    (Join-Path $projectRoot "MQL5/Experts/Exness_TradingBox_v1_012_MT5.mq5"),
...
Copy-Item (Join-Path $projectRoot "MQL5/Experts/Exness_TradingBox_v1_012_MT5.mq5") $targetEaFile -Force
